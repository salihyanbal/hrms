...
public class MMHKPSPublicSoap
{
    ...
    public MMHKPSPublicSoap(){}

    public MMHKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public MMHKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        MMHExtendedSoapSerializationEnvelope envelope= new MMHExtendedSoapSerializationEnvelope(MMHExtendedSoapSerializationEnvelope.VER11);
