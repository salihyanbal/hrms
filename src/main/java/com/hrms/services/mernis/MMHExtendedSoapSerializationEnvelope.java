...
public class MMHExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(MMHDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new MMHStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static MMHDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static MMHDateTimeConverter dateTimeConverter = new MMHStandardDateTimeConverter();

    public MMHExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public MMHExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new MMHMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=MMHHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,MMHExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=MMHHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
